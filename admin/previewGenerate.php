         ...
         <div class="row">
             <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                 <div class="position-sticky pt-3">
                     <ul class="nav flex-column ms-3">
                         ...
                         <li class="nav-item">
                             <a class="nav-link" aria-current="page" href="generate/frame.php">
                                 <span data-feather="home"></span>
                                 Generate
                             </a>
                         </li>
             ...
             <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                 <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                     ...
                     <button class="btn btn-warning fw-bold" onclick="frames['frame'].print();">Cetak</button>
                 </div>
                 <div class="container">
                     <div class="row">
                         <div class="col ratio ratio-16x9 border border-secondary">
                             <iframe src="generate/frame.php" name="frame"></iframe>
                         </div>
                     </div>
                 </div>
