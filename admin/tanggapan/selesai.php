                     ...
                     <ul class="nav flex-column ms-3">
                         ...
                         <li class="nav-item">
                             ...
                             <ul class="flex-column ms-3">
                                 ...
                                 <li class="nav-item">
                                     <a href="selesai.php" class="nav-link active">Selesai</a>
                                 </li>
                             </ul>
                         </li>
                                     ...
                                     <div class="col-sm-4 mb-3">
                                         <div class="card">
                                             ...
                                             <div class="card-body">
                                                 ...
                                                 <?php endif; ?>
                                                 <a href="tanggapan.php?id=<?= $data['id_pengaduan'] ?>" class="d-block mt-2 btn btn-info btn-sm text-decoration-none">Lihat Detail</a>
                                             </div>
                                         </div>
                                     </div>
                                 <?php endif; ?>
